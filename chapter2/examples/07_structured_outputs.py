...
print("관찰 포인트: 프롬프트가 아니라 enum 스키마가 허용 값을 제한합니다.")
print("=" * 60)
...
print()
print("=" * 60)
print("2부: 다중 필드 스키마 (prefill보다 안전하고 확장 가능한 방식)")
print("관찰 포인트: 파싱된 dict의 각 필드를 코드가 직접 사용합니다.")
print("=" * 60)
...
| 방식                      | 보장 수준          | 비고                    |
|---------------------------|--------------------|------------------------|
| 프롬프트 지시 (05)        | 부탁 — 어길 수 있음 | 가장 유연, 가장 약함    |
