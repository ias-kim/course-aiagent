...
모델 비교:
    ...
    │ Sonnet 4.6   │ 균형     │ 중간     │ 범용, 코딩, 분석   │
    │ Opus 4.8     │ 느림     │ 비쌈     │ 복잡한 추론, 창작   │
    └──────────────┴──────────┴──────────┴────────────────────┘
"""
...
#
# 1. GET /
#    모델 선택, 파라미터 조절, 채팅 UI를 포함한 메인 페이지
#
# ─────────────────────────────────────────────────────────────
#
# 2. POST /chat
#    사용자 메시지를 받아 선택된 모델로 호출한 뒤 SSE 스트리밍 응답을 반환합니다.
#
#    Request:
